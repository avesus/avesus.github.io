...
- Current title: `Some Cool CA`
- Current main heading: `Cellular automata from 2019`
- Current page says the experiments began in Spring 2019, before the Cartilage idea became clear in Fall 2020.
- Current page frames the experiments as alternative models of computation based on passing symbols that define local routing logic.
...
- Current page has no screenshot thumbnails for the listed local demos.
- Current page has no standard article navigation block.
...
Every local demo link should eventually have a screenshot preview thumbnail.
...
No local CA thumbnail images were found in the current asset inventory. The thumbnails should be captured from the live demos or generated from stable screenshots, not invented.
...
- one sentence on what the demo tests
...
- Capture screenshots for each local demo.
