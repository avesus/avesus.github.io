...
module top (
  ...
  SB_PLL40_2F_PAD #(
    ...
    //.DIVF(7'd14), // 180MHz  // feedback multiplier 0..63 => REF_CLK * 1..64
  ...
  // 144.39 MHz
  //reg [CH1_MSB:0] ch1_tune = 49'd1618883223194700;
  ...
  // 106.559 SUPER good signal
  reg [CH1_MSB:0] ch1_tune =   49'd604742285677685;

  // 106.559 MHz @ 180 MHz clock
  //reg [CH1_MSB:0] ch1_tune =   49'd414306145720156;

  //reg [CH1_MSB:0] ch1_tune =   49'd1360837687403780;

   //reg [CH1_MSB:0] ch1_tune = 49'd1618883223195860;
  // reg [CH1_MSB:0] ch1_tune = 49'd604742285677685;
   //                                 562949953421312
   //reg [CH1_MSB:0] ch1_tune = 45'd101180201449741;
   //reg [CH1_MSB:0] ch1_tune = 45'd20540971514718;
   //reg [CH1_MSB:0] ch1_tune = 45'd25801872865144;
   //                              35184372088832
   //                              70368744177664
...
// 220.7375
  ...
  // 45 bits - 2
  //wire [CH1_MSB:0] QUARTER_REG = 45'd8796093022208; // 2^(bits-2)
